...
function EditItem(e){
    ...
    document.getElementById('name').value=data.querySelector('#name').innerText;
    document.getElementById('email').value=data.querySelector('#email').innerText;
    document.getElementById('phone').value=data.querySelector('#phone').innerText;
